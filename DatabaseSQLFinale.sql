create schema e_learning authorization postgres;
set search_path to e_learning
...
CREATE TABLE TEST (
	IDT serial not null,
	Nome varchar(50) not null default 'Nome test non inserito',
...
/*----------------------------------------------------------------------|
|																		|
|						CREAZIONE TABELLA Gestione						|		
|																		|
|	Creazione tabella Gestione e implementazione vincoli di base		*/

CREATE TABLE Gestione (
	Operazione dominio_operazione not null,
...
ADD CONSTRAINT Gestione_FK1 FOREIGN KEY (Identificativo) 
REFERENCES INSEGNANTE (Identificativo)
ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE Gestione
ADD CONSTRAINT Gestione_FK2 FOREIGN KEY (IDT) REFERENCES TEST (IDT)
ON DELETE SET NULL ON UPDATE CASCADE;
/*----------------------------------------------------------------------*/
